...
//	if(_globals.tipsList==undefined || _globals.reloadTips==true) {
	...
	this.get='nearby';
		 foursquareGet(this,{
		 	endpoint: 'todos.json',
		 	requiresAuth: true,
		   parameters: {geolat:_globals.lat, geolong:_globals.long, geohacc:_globals.hacc,geovacc:_globals.vacc, geoalt:_globals.altitude, sort: 'nearby'},
	...
	//if(_globals.tipsList==undefined || _globals.reloadTips==true) {
		...
		this.get='friends';
		 foursquareGet(this,{
		 	endpoint: 'todos.json',
		 	requiresAuth: true,
		   parameters: {geolat:_globals.lat, geolong:_globals.long, geohacc:_globals.hacc,geovacc:_globals.vacc, geoalt:_globals.altitude, sort: 'recent'},
		   onSuccess: this.getTipsSuccess.bind(this),
		   onFailure: this.getTipsFailed.bind(this)		 	
		 });
	/*}else{
