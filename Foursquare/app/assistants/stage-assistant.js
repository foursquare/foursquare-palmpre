Mojo.Log.error("laucnhing stageassistant");
...
StageAssistant.prototype.setup = function() {
	...
	//this.getUA();
	//zBar.activeScene=Mojo.Controller.stageController.activeScene();
	...
	if (credentials /*&& 1==2*//*uncomment the comment before this to force the login dialog*/){
		...
		//var su=bitly.shorten("http://zhephree.com/foursquare",function(r){Mojo.Log.error(r.responseJSON.results."http://zhephree.com/foursquare".shortURL);});
...
var bitly={
	login: "zhephree",
	key: "R_0cfdd101b684d904b799c5e234e0201e",
	version: "2.0.1",
	format: "json"
};
...
bitly.shorten=function(url,callback) {
	var url = 'http://api.bit.ly/shorten?version='+bitly.version+'&longUrl='+url+'&login='+bitly.login+'&apiKey='+bitly.key;
	var request = new Ajax.Request(url, {
	   method: 'get',
	   evalJSON: 'force',
