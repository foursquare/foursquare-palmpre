...
AddVenueDialogAssistant.prototype.setup = function(widget) {
  ...
  Mojo.Log.error("setup buttons");
	...
	this.sceneAssistant.controller.setupWidget('venue-name', this.nameAttributes = {hintText:'Venue Name',multiline:false,focus:true}, this.nameModel = {value:'', disabled:false});
	this.sceneAssistant.controller.setupWidget('venue-address', this.addressAttributes = {hintText:'Address',multiline:false,focus:false}, this.addressModel = {value:'', disabled:false});
	this.sceneAssistant.controller.setupWidget('venue-crossstreet', this.crossstreetAttributes = {hintText:'Cross Street',multiline:false,focus:false}, this.crossstreetModel = {value:'', disabled:false});
	this.sceneAssistant.controller.setupWidget('venue-city', this.cityAttributes = {hintText:'City',multiline:false,focus:false}, this.cityModel = {value:'', disabled:false});
	this.sceneAssistant.controller.setupWidget('venue-zip', this.zipAttributes = {hintText:'Zip',multiline:false,focus:false}, this.zipModel = {value:'', disabled:false});
	this.sceneAssistant.controller.setupWidget('venue-phone', this.phoneAttributes = {hintText:'Phone',multiline:false,focus:false}, this.phoneModel = {value:'', disabled:false});

Mojo.Log.error("setup textbxes");


    this.sceneAssistant.controller.setupWidget("venue-state",
...
AddVenueDialogAssistant.prototype.activate = function() {
